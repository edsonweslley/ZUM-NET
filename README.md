# ZUM-NET
Baseando-se no desenvolvimento do [netcat](https://www.varonis.com/pt-br/blog/netcat-commands), e utilizando alguns recursos bibliográficos, aqui está uma versão menos robusta do netcat.
